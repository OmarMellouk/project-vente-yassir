	...
	private ProduitsRepository prodRepository ;
	 ...
	 @PostMapping("/produits")
	    ...
	    public produits updateProduit(@PathVariable(value = "id") Long produitId,
			...
			produit.setQntttc(produitDetails.getQntttc());
			produit.setQntnoir(produitDetails.getQntnoir());
			produit.setPrix(produitDetails.getPrix());
			produit.setPrixachat(produitDetails.getPrixachat());
			produit.setRef(produitDetails.getRef());
			produit.setCat(produitDetails.getCat());
			produit.setUnit(produitDetails.getUnit());
